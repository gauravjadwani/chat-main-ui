...
(function($) {
    $.widget("ui.chatbox", {
        ...
        _create: function() {
            ...
            $(document).on('keydown','.ui-chatbox-input-box',function(event) {
                
                if (event.keyCode && event.keyCode == $.ui.keyCode.ENTER) {
                     msg = $.trim($(this).html());
                    // console.log("msg is "+msg);
                    // console.log("this is "+$(this).prop("class"));

                   
                    if (event.shiftKey) {
                        // console.log("Shift pressed");
                                console.log("msg is "+msg);
                                   // console.log( $('.emoji-wysiwyg-editor').prop("class"));
                        //var u = $('.emoji-wysiwyg-editor').prop("selectionStart");
                        t=window.getSelection($('.emoji-wysiwyg-editor')).anchorOffset;
                        // console.log("the u is "+t);
                        part1 = msg.substring(0,t)+'</br>';
                        //var q=$(this).html(part1);
                         //$(this).html(part1);
                        console.log("part1 is "+part1);
                        console.log("ms length "+msg.length);
                        part2 = msg.substring(t);
                        //var w=$(this).html(part2);
            ...
            $(document).on('focusin','.ui-chatbox-input-box',function() {
            ...
            $(document).on('focusout','.ui-chatbox-input-box',function() {
