calling_obj = null;
window.channel_id = 'presence-123';
...
var chat = $.fn.construct = function(object) {
    ...
    var pusher = new Pusher(key, {
        // encrypted: true,
        authEndpoint: 'auth.php',authTransport: 'ajax' 
    });
 ...
 /*       localstorage = localStorage.getItem(channel_id);
        ...
        $(".ui-chatbox-input").append('<a href="javascript:void(0)" class="emoji-boxx" title="" data-toggle="popover" data-placement="top" data-content=""><i  class="twa twa-relaxed twa-lg" title="relaxed"></i></a>');
...
console.log("exitting document.ready");
  ...
  channel.bind('pusher:subscription_succeeded', function(members) {console.log("subscription_succeeded");
  // var triggered = channel.trigger('client-t', { your: "data" });
});
   
channel.bind('pusher:subscription_error', function(status) {console.log("subscription_error"+status);});
