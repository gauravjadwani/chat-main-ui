...
var chat = $.fn.construct = function(object) {
    ...
    $(document).ready(function() {
        ...
        emojis_array={':+1:':'twa twa-relaxed twa-lg emoji-content',':+2:':'twa twa-satisfied twa-lg emoji-content',':+3:':'twa twa-thumbsup twa-lg emoji-content',':+4:':'twa twa-laughing twa-lg emoji-content',':+5:':'twa twa-worried twa-lg emoji-content'};
     ...
     /*   $('.emoji-content').on('load', function() {
            console.log("boxdf");
        });
        $('.popover-content').ready(function() {
            console.log("popover-content compelted");
            console.log($('.popover-content').children());
        });
   ...
   pusher_creation();
    ...
    /* $(document).on('click','.emoji-boxx',function(){
