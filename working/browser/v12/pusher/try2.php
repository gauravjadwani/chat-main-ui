...
<i id=:+1: class='twa twa-relaxed twa-lg emoji-content' title='relaxed'></i>
<i id=:+2: class='twa twa-satisfied twa-lg emoji-content' title='satisfied'></i>
<i id=:+3: class='twa twa-thumbsup twa-lg emoji-content' title='thumbsup'></i>
<i id=:+4: class='twa twa-laughing twa-lg emoji-content' title='laughing'></i>
<i id=:+5: class='twa twa-worried twa-lg emoji-content' title='worried'></i>
<div id="chat_div">
