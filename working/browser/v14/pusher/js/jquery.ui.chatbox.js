        ...
        options: {
            ...
            boxManager: {
                ...
                addMsg: function(peer, msg,time) {
                    ...
                    console.log(distime);
                    // document.getElementsByClassName('time')[0].innerHTML('guarav');
                    distime.innerHTML=time;
                    // console.log($('.time').html('timedw'));
                     // $('time').val('time');
                     // var op=$('You').wrap(e);
                    box.append(distime);
                    box.append(e);
